...
def insert_default_booths(session: Session):
    booths = [
            ...
            Booth(
                booth_name='방씨네 츄러스',
                booth_description="""백 츄러스 : 스페인 전통 츄러스 + 수제 블루베리 잼 + 바닐라 아이스크림
                
                흑 츄러스 : 수제 초코 츄러스 + 딥 초코소스 + 바닐라아이스크림 + 시나몬 파우더
                
                “제가 경상대에서 츄러스 제일 잘해요.”
                
                백수저 vs 흑수저. 계급을 증명할 것인가, 계급을 넘어설 것인가.

                오직 맛으로만 승부하는 12인의 치열한 요리 전쟁이 시작됩니다. 
                .
                .
                백 츄러스 : 스페인 전통 츄러스 + 수제 블루베리 잼 + 바닐라 아이스크림

                흑 츄러스 : 수제 초코 츄러스 + 딥 초코소스 + 바닐라아이스크림 + 시나몬 파우더
                .
                .

                <방씨네츄러스_대동제 부스 전쟁>, 10월 16일 ~ 10월 18일 오직 🔮2024 대동제; PIESTA🔮에서
                .
                .
                .
                여러분의 투표를 기다리고 있습니다""",
